...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<alb-big-input-action></alb-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<alb-big-input-action [disabled]="true"></alb-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<alb-big-input-action fontSet="fas" fontIcon="trash"></alb-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<alb-big-input-action label="delete"></alb-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<alb-big-input-action (action)="actionHandler()"></alb-big-input-action>';
    fixture = createHostComponent(template);
